const {
  ...
  // Main function that creates a new multisig account, attempts a transfer with one signature (which will fail),
  // successfully transfers with two signatures, queries the account balances, and then logs the balances before exiting the process.
  async function main() {
